...
export const CURRENCY_CONFIG = {
  ...
  DKK: {
    ...
    sectionSeparator: `,`,
    decimalSeparator: `.`,
    currencySymbolFront: false,
    currencySymbolSpacing: ` `,
    currencySymbol: CURRENCY_SYMBOLS.DKK,
  },
  SEK: {
    precision: 2,
    sectionSize: 3,
    ...
    currencySymbolFront: false,
    currencySymbolSpacing: ` `,
    currencySymbol: CURRENCY_SYMBOLS.SEK,
  },
  CAD: {
    precision: 2,
    sectionSize: 3,
    ...
    currencySymbolFront: true,
    currencySymbolSpacing: ``,
    currencySymbol: CURRENCY_SYMBOLS.CAD,
  },
  NZD: {
    precision: 2,
    sectionSize: 3,
    ...
    currencySymbolFront: true,
    currencySymbolSpacing: ``,
    currencySymbol: CURRENCY_SYMBOLS.NZD,
  },
  INR: {
    precision: 2,
    sectionSize: 3,
  ...
  JPY: {
    ...
    currencySymbolFront: true,
    currencySymbolSpacing: ``,
    currencySymbol: CURRENCY_SYMBOLS.JPY,
  },
};
