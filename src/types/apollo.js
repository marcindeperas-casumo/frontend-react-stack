...
// ====================================================
// GraphQL query operation: playAgainGameByIdQuery
// ====================================================

export type playAgainGameByIdQuery_games = {
  id: string,
  slug: string,
  logo: string,
  logoBackground: string,
...
export type playAgainGameByIdQuery = {
  games: Array<playAgainGameByIdQuery_games>
};

export type playAgainGameByIdQueryVariables = {
  id: string
};
/* @flow */
/* eslint-disable */
...
// ====================================================
// GraphQL query operation: latestPlayedQuery
// ====================================================

export type latestPlayedQuery_gamesList = {
  gameIds: ?Array<?string>
};

export type latestPlayedQuery = {
  gamesList: ?latestPlayedQuery_gamesList
};
/* @flow */
/* eslint-disable */
// This file was automatically generated and should not be edited.
...
export type ValuableCard_PlayerValuable_PlayerValuableCash = {
  __typename: "PlayerValuableCash" | "PlayerValuableDeposit" | "PlayerValuableFreeBet" | "PlayerValuableSport",
  id: string,
  title: string,
  content: string,
  valuableState: PlayerValuableState,
