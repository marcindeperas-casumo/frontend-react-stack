...
const loadMixpanelIfNeeded = () => {
  ...
  /* eslint-disable curly, no-undef, eqeqeq, fp/no-arguments, fp/no-loops, fp/no-mutating-methods, fp/no-mutation, no-cond-assign, no-restricted-globals, no-unused-expressions, no-var, prettier/prettier */
  // $FlowFixMe
