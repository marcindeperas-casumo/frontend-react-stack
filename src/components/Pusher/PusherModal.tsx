...
export enum PUSHER_MODAL_STATE {
  HIDDEN,
  FIRST_LAYER_VISIBLE,
...
const STATE_TRANSITIONS = {
  ...
  [PUSHER_MODAL_STATE.SECOND_LAYER_VISIBLE]: PUSHER_MODAL_STATE.FIRST_LAYER_VISIBLE,
};
...
export const PusherModal = ({
  ...
  const [pusherModalState, setPusherModalState] =
    useState<PUSHER_MODAL_STATE>(PUSHER_MODAL_STATE.HIDDEN);
