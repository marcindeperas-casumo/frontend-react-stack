...
export const GameDetailsButtons = ({
  ...
  <div className="u-zindex--content-overlay u-position-fixed@mobile o-inset-bottom--none u-left-shell-offset o-inset-right--none t-background-white u-padding--md u-width--full@tablet u-width--2/3@desktop u-margin-x--auto">
    <TrackClick
