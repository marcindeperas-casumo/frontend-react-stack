...
export const ProfileIconWithDrawer = ({
  ...
  return (
    <React.Fragment>
      ...
      {isDrawerOpen && (
        <div
          className={`${baseClassName}__bottom-wrapper-bg u-position-absolute u-zindex--header u-width--full u-width--1/5@desktop u-padding@mobile u-padding@tablet u-padding-top--md@mobile u-padding-top--md@tablet u-padding-left@desktop u-padding-right--lg@desktop`}
        >
          {shouldShowReelRace && (
