...
export const LazySports = React.memo(props => (<LazyPortal hostElementId="react-host-sports-shell" loader={() => import("Features/sports/components/SportsShell")} fallback={<SportsShellSkeleton />} namedExport="SportsShellContainer" props={props}/>), 
