...
export class PromotionTeaserList extends PureComponent<Props> {
  ...
  render() {
    ...
    return (
      <div className="u-padding-bottom--xlg o-wrapper u-margin-top--5xlg@tablet u-padding-top--lg u-margin-top--5xlg@desktop bg-white t-border-r--none t-border-r--md@tablet t-border-r--md@desktop">
