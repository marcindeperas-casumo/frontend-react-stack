  ...
  return (
    <div
      className={classNames(
        "c-sidebar u-width--full u-position-absolute u-height--screen u-overflow-y--auto t-color-white u-font u-font-weight-bold",
        isSidebarFixed && "c-sidebar--fixed u-position-relative"
      )}
    >
      <SidebarIconClose />
